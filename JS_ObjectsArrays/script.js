...
console.log("energylevels van kat 1:", catBreeds[0].energy_level)
console.log("het eerste temperament van de temperamenten van de tweede kat:", catBreeds[1].temperament[0])
console.log("het laatst temperament van de temperamenten van de derde kat:", catBreeds[2].temperament.slice(-1)[0])
